...
/**
 * الاستثناء ده كان فيه تلات ملفات من zad-market-intelligence — استعلامات كسيرة في كود
 * مش متوصّل بأي حاجة. التعليق وقتها قال إن مسحهم "قرار منتج مش تقني". القرار ده
 * اتاخد في 2026-09-05: الفانكشن كلها اتمسحت (محدش كان بيناديها — لا كرون ولا تطبيق
 * ولا فانكشن تانية)، فالاستثناء بقى فاضي.
 *
 * سيبه فاضي. أي ملف يتحط هنا معناه إن الفحص مش شغّال عليه، وده لازم يفضل استثناء
 * مقصود ومكتوب سببه، مش مكان يتخبّى فيه كود كسير.
 */
