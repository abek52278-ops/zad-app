...
export function voiceModeInstruction(enabled: boolean): string {
  return enabled
    ? "هذه مكالمة صوتية: ردي بجمل قصيرة سهلة السماع كأنك بنت بتكلم صاحبتك على التليفون — دافية، طبيعية، فيها إحساس بسيط (فرحة/اهتمام/استغراب) حسب الموضوع. من غير Markdown ولا قوائم ولا أرقام هاردكود، وسيبي مساحة المستخدم يقاطعك. الصوت اللي هينطقك أنثوي، فخلي ردك يناسب صوت بنت شقتية لطيفة."
