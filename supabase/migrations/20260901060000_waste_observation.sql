-- إضافة ملاحظة "الهدر" لـ zad_domain_observations — ملخّص شهري بسيط من zad_waste_log
-- (المُتَبَع بـtrigger في 20260901050000_waste_tracking.sql)، مش تفصيل صنف صنف. severity
-- 'low' عمدًا: ده معلومة للانتباه، مش تحذير عاجل.
...
BEGIN
  ...
  -- جديد: ملخّص هدر آخر ٣٠ يوم — بس لو صنفين أو أكتر، عشان صدفة واحدة ماتبقاش ملاحظة.
